...
export const ExponentialFunction: React.FC = () => {
    ...
    const instructions = [
        ...
        'Используйте слайдер b для изменения основания степени',
        'Используйте слайдер c для вертикального сдвига',
        'Горизонтальная асимптота показана пунктирной линией',
        'Точка пересечения с осью Y показана цветным кружком'
    ];

    // Calculate exponential points
            ...
            <div className="flex-1 flex overflow-hidden">
                <div className="flex-1 flex items-center justify-center bg-gray-50 p-8">
                    <div className="w-full max-w-2xl">
                        <svg viewBox="0 0 400 300" className="w-full h-auto border border-gray-200 rounded-lg bg-white shadow-sm">
                            <CoordinateGrid width={400} height={300} scale={40} originX={200} originY={150} gridId="grid-exp" />
                            ...
                            <line
                                ...
                                strokeDasharray="5,5"
                            />
                            <text x="10" y={150 - c * 40 - 5} className="text-xs fill-red-600 font-medium">
                                y = {c.toFixed(1)}
                            </text>
                            ...
                            <circle
                                cx={200}
                                cy={150 - yIntercept * 40}
                                r="5"
                                fill="#F59E0B"
                            />
                            <text x={210} y={150 - yIntercept * 40 - 5} className="text-xs fill-amber-600 font-medium">
                ...
                <div className="w-96 border-l bg-white overflow-y-auto">
                    <div className="p-6 space-y-6">
                        <div>
                            <h3 className="text-lg font-semibold text-gray-800">Показательная функция</h3>
                            <span className="text-sm text-gray-500">y = a · b<sup>x</sup> + c</span>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm">
                            <div className="p-2 bg-gray-50 rounded">
                                ...
                                <span className="font-medium">y = {c.toFixed(1)}</span>
                            </div>
                            <div className="p-2 bg-gray-50 rounded">
                                <span className="text-gray-500">Пересечение с Y: </span>
                                <span className="font-medium">(0, {yIntercept.toFixed(1)})</span>
                            </div>
                        </div>
                    </div>
                </div>
